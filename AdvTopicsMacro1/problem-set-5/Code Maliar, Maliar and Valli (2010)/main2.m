...
N=100;          % number of agents for the stochastic simulation default 10000

% Parameters for Method 2 only

J=100;           % number of grid points for the non-stochastic simulation -- default 1000
...
dif_B=2^5;   % difference between coefficients B of the the ALM on 
