...
% commented/edited by Aisha & Antonia
...
prob_ag=zeros(2,2);  
prob_ag(1,1)=prob(1,1)+prob(1,2); 
prob_ag(2,1)=1-prob_ag(1,1);  
prob_ag(2,2)=prob(3,3)+prob(3,4); 
...
% s' is realized; (CONDITIONAL PROB)
%__________________________________________________________________________
...
%__________________________________________________________________________
%
% Generation of the aggregate shocks (use prob from above)
%__________________________________________________________________________
